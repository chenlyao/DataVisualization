import 'main/ArcGISAPI/measure/leaflet-measure.scss';
...
L.Control.Measure = L.Control.extend({
  ...
  options: {
    ...
    activeColor: '#ABE67E', // base color for lqmap features while actively measuring
  ...
  // do final calc and finish out current measure, clear dom and internal state, add permanent lqmap features
  ...
  // handle lqmap click during ongoing measurement
  ...
  // handle lqmap mouse out during ongoing measure
  // remove floating cursor vertex from lqmap
  ...
  // add various measure graphics to lqmap - vertex, area, boundary
